...
export const PremiumHero = () => {
  ...
  const aiTitles = ["امروز؟", "فردا؟", "جنگ میشه؟", "هیچوقت", "بابا بزن"];
      ...
      <div className="relative z-20 flex h-screen w-full items-center justify-center px-6 text-center">
        <div className="container mx-auto flex flex-col items-center gap-12 text-center">
          ...
          <h1 className="text-5xl md:text-7xl max-w-2xl tracking-tighter font-regular">
            ...
            <span className="relative flex w-full justify-center overflow-hidden md:pb-4 md:pt-1 py-10">
              &nbsp;
              {aiTitles.map((title, index) => (
                <motion.span
                  key={index}
                  className="absolute  text-white dark:text-gray-300 mt-4"
          ...
          <p className="text-lg md:text-xl leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center">
            تاریخچه تمام واریز های حقوق شرکت تان را روی نمودار ببینید و مقایسه کنید. همچنین از واریز حقوق ماه آینده مطلع شوید
          </p>
